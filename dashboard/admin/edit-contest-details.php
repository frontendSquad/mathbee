...
<section id="edit-contest-details" class="edit-contest-details-page">
    <div class="content-body">
        <div class="page-title mb-5">
            <div class="row">
                <div class="col-12 col-lg-12">
                    <h2><a href="view-contest-details.php"><i class="fas fa-long-arrow-alt-left"></i></a> Edit Contest</h2>
                </div>
            </div>
        </div>
        ...
        <div class="detail-block">
            <div class="row">
                <div class="col-xxl-4 col-xl-6 col-lg-8 col-md-10 lablename">
                    ...
                    <button class="btn btn-red" data-bs-toggle="modal" data-bs-target=".contest-updated">Update</button>
                </div>
            </div>
        </div>
    </div>
