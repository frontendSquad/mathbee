...
<section id="view-student-details" class="view-student-details-page">
    <div class="content-body">
        <div class="page-title mb-5">
            <div class="row">
                <div class="col-12 col-lg-12">
                    <h2><a href="student-management.php"><i class="fas fa-long-arrow-alt-left"></i></a> Student Details</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-8 col-lg-10">
                <div class="detail-block media d-lg-flex d-block">
                    ...
                    <div class="media-body flex-grow-1">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a href="edit-student-details.php" class="btn btn-red">Edit</a>
                            </div>
                        </div>
                    </div>
                </div>
