...
<section id="contest-management" class="contest-management-page">
    <div class="row">
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-block d-md-flex align-items-center justify-content-between">
                                ...
                                <a href="create-contest-details.php" class="btn btn-red mt-md-0 mt-3">Create</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="btn-group ml-1">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="#_" data-bs-toggle="modal" data-bs-target=".inactive-contest"><i class="fas fa-ban"></i> Inactive</a>
                                                <a class="dropdown-item" href="view-contest-details.php"><i class="far fa-eye"></i> View</a>
                                                <a class="dropdown-item" href="edit-contest-details.php"><i class="fas fa-pen"></i> Edit</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group ml-1">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="#_" data-bs-toggle="modal" data-bs-target=".active-contest"><i class="fas fa-ban"></i> Active</a>
                                                <a class="dropdown-item" href="view-contest-details.php"><i class="far fa-eye"></i> View</a>
                                                <a class="dropdown-item" href="edit-contest-details.php"><i class="fas fa-pen"></i> Edit</a>
                                            </div>
                                        </div>
