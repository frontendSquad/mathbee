...
<section id="teacher-management" class="teacher-management-page">
    <div class="row">
        <div class="col-12">
                                    ...
                                    <td>
                                        <div class="btn-group ml-1">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="#_" data-bs-toggle="modal" data-bs-target=".inactive-teacher"><i class="fas fa-ban"></i> Inactive</a>
                                                <a class="dropdown-item" href="view-teacher-details.php"><i class="far fa-eye"></i> View</a>
                                                <a class="dropdown-item" href="edit-teacher-details.php"><i class="fas fa-pen"></i> Edit</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group ml-1">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="#_" data-bs-toggle="modal" data-bs-target=".active-teacher"><i class="fas fa-ban"></i> Active</a>
                                                <a class="dropdown-item" href="view-teacher-details.php"><i class="far fa-eye"></i> View</a>
                                                <a class="dropdown-item" href="edit-teacher-details.php"><i class="fas fa-pen"></i> Edit</a>
                                            </div>
                                        </div>
